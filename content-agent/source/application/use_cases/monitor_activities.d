...
class MonitorActivitiesUseCase
{
    ...
    ActivitySummary getSummary(TenantId tenantId)
    {
        ...
        foreach (ref a; all)
        {
            ...
            {
                case ActivitySeverity.info: summary.infoCount++; break;
                case ActivitySeverity.warning: summary.warningCount++; break;
                case ActivitySeverity.error: summary.errorCount++; break;
            }
        }
    ...
    private static ActivityType parseActivityType(string s)
    {
        switch (s)
        {
            ...
            default: return ActivityType.packageCreated;
        }
    }
}
