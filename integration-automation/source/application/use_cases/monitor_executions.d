...
class MonitorExecutionsUseCase
{
    ...
    WorkflowSummary getWorkflowSummary(WorkflowId workflowId, TenantId tenantId)
    {
        ...
        foreach (ref s; steps)
        {
            ...
            {
                case StepStatus.pending: pending++; break;
                case StepStatus.inProgress: inProg++; break;
                case StepStatus.completed: completed++; break;
                case StepStatus.failed: failed++; break;
                case StepStatus.skipped: skipped++; break;
                case StepStatus.blocked: pending++; break;
            }
        }
