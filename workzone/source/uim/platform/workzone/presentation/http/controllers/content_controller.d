...
class ContentController
{
    ...
    private void handleCreate(scope HTTPServerRequest req, scope HTTPServerResponse res)
    {
        try
        {
            ...
            else if (ctStr == "announcement") r.contentType = ContentType.announcement;
            else if (ctStr == "document") r.contentType = ContentType.document;
            else r.contentType = ContentType.blogPost;
