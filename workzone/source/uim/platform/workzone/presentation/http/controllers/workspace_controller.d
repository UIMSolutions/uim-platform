...
class WorkspaceController
{
    ...
    private void handleCreate(scope HTTPServerRequest req, scope HTTPServerResponse res)
    {
        try
        {
            ...
            else if (typeStr == "external") r.type = WorkspaceType.external;
            else r.type = WorkspaceType.team;
    ...
    private void handleGet(scope HTTPServerRequest req, scope HTTPServerResponse res)
    {
        try
        {
            ...
            if (id == "members") { handleAddMember(req, res); return; }
    ...
    private void handleAddMember(scope HTTPServerRequest req, scope HTTPServerResponse res)
    {
        try
        {
            ...
            else r.role = MemberRole.contributor;
