...
*****************************************************************************************************************/
module uim.platform.monitoring.infrastructure.persistence.repositories.alerts;
...
@safe:
class AlertRepository : TenantRepository!(Alert, AlertId), IAlertRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new AlertRepository()));
}
