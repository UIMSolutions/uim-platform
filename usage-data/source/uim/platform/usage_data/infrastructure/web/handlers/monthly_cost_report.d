...
*****************************************************************************************************************/
module uim.platform.usage_data.infrastructure.web.handlers.monthly_cost_report;
...
class MonthlyCostReportHandler {
  private MonthlyCostReportUseCases useCases;

  this(MonthlyCostReportUseCases useCases) {
  ...
  void getOne(scope HTTPServerRequest req, scope HTTPServerResponse res) {
    ...
    auto item = useCases.getReport(TenantId.init, MonthlyCostReportId(id));
    if (item.isEmpty) {
