...
*****************************************************************************************************************/
module uim.platform.ai_launchpad.application.use_cases.manage_models;
...
class ManageModelsUseCase : UIMUseCase {
  ...
  Model get_(ModelId id, ConnectionId connectionId) {
  ...
  CommandResult patch(PatchModelRequest r) {
    ...
    if (m.id.length == 0) return CommandResult(false, "", "Model not found");
