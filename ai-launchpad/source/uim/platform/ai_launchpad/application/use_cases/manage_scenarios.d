...
*****************************************************************************************************************/
module uim.platform.ai_launchpad.application.use_cases.manage_scenarios;

import uim.platform.ai_launchpad.domain.ports.scenario_repository;
...
class ManageScenariosUseCase {
  ...
  CommandResult remove(ScenarioId id, ConnectionId connectionId) {
    ...
    if (s.id.length == 0) return CommandResult(false, "", "Scenario not found");
