...
class ConnectionValidator {
  ValidationResult validate(ref Connection c) {
    ...
    if (c.clientId.length == 0) return ValidationResult(false, "Client ID is required");
    if (c.workspaceId.length == 0) return ValidationResult(false, "Workspace ID is required");
