...
struct CreateSubstitutionRuleRequest {
  TenantId tenantId;
  SubstitutionRuleId ruleId; // This is needed to ensure idempotency of the request. The client can generate a UUID and pass it here. If a substitution rule with the same ID already exists, the service can return the existing rule instead of creating a new one.
