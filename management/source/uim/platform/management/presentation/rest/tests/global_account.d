module uim.platform.management.presentation.rest.tests.global_account;
...
unittest {
    ...
    router.registerRestInterface(new GlobalAccountApi(container.manageGlobalAccounts), "/rest/v1/");
    ...
    auto clientTask = runTask({
        try {
            ...
            auto client = new RestInterfaceClient!IGlobalAccountApi(basisUrl);
