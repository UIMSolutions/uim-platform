module uim.platform.management.presentation.rest.tests.label;
...
unittest {
    ...
    auto clientTask = runTask({
        try {
            ...
            auto ergebnis = client.getLabels("test-tenant");

            // Your assertions
            assert(ergebnis.length >= 0, "The list should be initializable");
