module uim.platform.management.presentation.rest.tests.subscription;
...
unittest {
    ...
    logInfo("--- Starting Service-Unittest for Subscription ---");
    ...
    router.registerRestInterface(new SubscriptionApi(container.manageSubscriptions), "/rest/v1/");
    ...
    auto clientTask = runTask({
        try {
            ...
            auto client = new RestInterfaceClient!ISubscriptionApi(basisUrl);
