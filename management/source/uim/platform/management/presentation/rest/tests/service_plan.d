module uim.platform.management.presentation.rest.tests.service_plan;
...
unittest {
    ...
    router.registerRestInterface(new ServicePlanApi(container.manageServicePlans), "/rest/v1/");
...
scope (exit) {
    ...
    auto clientTask = runTask({
        try {
            ...
            auto client = new RestInterfaceClient!IServicePlanApi(basisUrl);
