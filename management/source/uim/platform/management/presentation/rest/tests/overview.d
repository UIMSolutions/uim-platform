module uim.platform.management.presentation.rest.tests.overview;
...
unittest {
    ...
    router.registerRestInterface(new OverviewApi(container.getOverview), "/rest/v1/");
...
scope (exit) {
    ...
    auto clientTask = runTask({
        try {
            ...
            auto client = new RestInterfaceClient!IOverviewApi(basisUrl);
