...
class DH5Canvas : DH5Obj {
	...
	auto addColorStop(this O)(string varName, string stop, string color) {
		this.js(varName ~ ".addColorStop(" ~ stop ~ "," ~ color ~ ");");
		return cast(O) this;
	}
...
*/
	...
	auto arc(this O)(int x, int y, int r, int sAngle, int eAngle, bool b = false) {
		this.js(pre ~ "arc(%s,%s,%s,%s,%s,%s);".format(x, y, r, sAngle, eAngle, b ? "true" : "false"));
		return cast(O) this;
	}
	...
	auto arcTo(this O)(int x1, int y1, int x2, int y2, int r) {
		this.js(pre ~ "arcTo(%s,%s,%s,%s,%s);".format(x1, y1, x2, y2, r));
		return cast(O) this;
	}
	...
	auto beginPath(this O)() {
		this.js(pre ~ "beginPath();");
		return cast(O) this;
	}

	// BezierCurveTo() 	Creates a cubic Bézier curve
	auto bezierCurveTo(this O)(int cpx0, int cpy0, int cpx1, int cpy1, int x, int y) {
		this.js(pre ~ "bezierCurveTo(%s,%s,%s,%s,%s,%s);".format(cpx0, cpy0, cpx1, cpy1, x, y));
		return cast(O) this;
	}
	...
	auto clearRect(this O)(int x, int y, int width, int height) {
		this.js(pre ~ "clearRect(%s,%s,%s,%s);".format(x, y, width, height));
		return cast(O) this;
	}
...
*/
	...
	auto closePath(this O)() {
		this.js(pre ~ "closePath();");
		return cast(O) this;
	}

	// CreateImageData() 	Creates a new, blank ImageData object
	auto createImageData(this O)(double width, double height) {
		this.js(pre ~ "createImageData(%s,%s)".format(width, height));
		return cast(O) this;
	}
	...
	auto createImageData(this O)(string image) {
		this.js(pre ~ "createImageData(%s)".format(image));
		return cast(O) this;
	}

	// CreateLinearGradient() 	Creates a linear gradient (to use on canvas content)
	auto createLinearGradient(this O)(string varName, int x0, int y0, int x1, int y1) {
		this.js("var %s=context.createLinearGradient(%s,%s,%s,%s);".format(varName, x0, y0, x1, y1));
		return cast(O) this;
	}
...
*/
	...
	auto createPattern(this O)(string varName, string image, string mode) {
		this.js("var %s=context.createPattern(%s,%s);".format(varName, image, mode));
		return cast(O) this;
	}
...
*/
	...
	auto createRadialGradient(this O)(string varName, int x0, int y0, int r0, int x1, int y1, int r1) {
		this.js("var %s=context.createRadialGradient(%s,%s,%s,%s,%s,%s);".format(varName, x0, y0, r0, x1, y1, r1));
		return cast(O) this;
	}
...
*/
	...
	auto drawImage(this O)(string image, double x, double y) {
		this.js(pre ~ "drawImage(%s,%s,%s);".format(image, x, y));
		return cast(O) this;
	}
	...
	auto drawImage(this O)(string image, double x, double y, double width, double height) {
		this.js(pre ~ "drawImage(%s,%s,%s,%s,%s);".format(image, x, y, width, height));
		return cast(O) this;
	}
	...
	auto drawImage(this O)(string image, double sx, double sy, double sWidth, double sHeight, double x, double y, double width, double height) {
		this.js(pre ~ "drawImage(%s,%s,%s,%s,%s,%s,%s,%s,%s);".format(image, sx, sy, sWidth, sHeight, x, y, width, height));
		return cast(O) this;
	}
	...
	auto fillRect(this O)(int x, int y, int width, int height) {
		this.js(pre ~ "fillRect(%s,%s,%s,%s);".format(x, y, width, height));
		return cast(O) this;
	}
...
*/
	...
	auto fillText(this O)(string text, double x, double y) {
		this.js(pre ~ "fillText(%s,%s,%s);".format(text, x, y));
		return cast(O) this;
	}

	auto fillText(this O)(string text, double x, double y, double maxWidth) {
		this.js(pre ~ "fillText(%s,%s,%s,%s);".format(text, x, y, maxWidth));
		return cast(O) this;
	}
	...
	auto globalAlpha(this O)(double number) {
		this.js(pre ~ "globalAlpha(%s);".format(number));
		return cast(O) this;
	}
	...
	auto globalCompositeOperation(this O)(CompositeOperations operation) {
		this.js(pre ~ "globalCompositeOperation='%s';".format(operation));
		return cast(O) this;
	}
	...
	auto isPointInPath(this O)(double x, double y) {
		this.js(pre ~ "isPointInPath(%s,%s);".format(x, y));
		return cast(O) this;
	}
	...
	auto lineTo(this O)(int x, int y) {
		this.js(pre ~ "lineTo(%s,%s);".format(x, y));
		return cast(O) this;
	}
	...
	auto lineWidth(this O)(uint value) {
		this.js(pre ~ "lineWidth=%s;".format(value));
		return cast(O) this;
	}
	...
	auto miterLimit(this O)(uint length) {
		this.js(pre ~ "miterLimit=%s;".format(length));
		return cast(O) this;
	}
	...
	auto measureText(this O)(string varName, string text) {
		this.js(("%s=" ~ pre ~ "measureText(%s).width;").format(varName, text));
		return cast(O) this;
	}

	// MoveTo() 	Moves the path to the specified point in the canvas, without creating a line
	auto moveTo(this O)(int x, int y) {
		this.js(pre ~ "moveTo(%s,%s);".format(x, y));
		return cast(O) this;
	}
	...
	auto putImageData(this O)(string image, double x, double y) {
		this.js(pre ~ "putImageData(%s,%s,%s);".format(image, x, y));
		return cast(O) this;
	}
	...
	auto putImageData(this O)(string image, double x, double y, double dirtyX, double dirtyY, double dirtyWidth, double dirtyHeight) {
		this.js(pre ~ "putImageData(%s,%s,%s,%s,%s,%s,%s);".format(image, x, y, dirtyX, dirtyY, dirtyWidth, dirtyHeight));
		return cast(O) this;
	}
	...
	auto quadraticCurveTo(this O)(int cpx, int cpy, int x, int y) {
		this.js(pre ~ "quadraticCurveTo(%s,%s,%s,%s);".format(cpx, cpy, x, y));
		return cast(O) this;
	}
	...
	auto rect(this O)(int x, int y, int width, int height) {
		this.js(pre ~ "rect(%s,%s,%s,%s);".format(x, y, width, height));
		return cast(O) this;
	}
	...
	auto rotate(this O)(double angle) {
		this.js(pre ~ "rotate(%s);".format(angle));
		return cast(O) this;
	}
	...
	auto scale(this O)(double scaleWidth, double scaleHeight) {
		this.js(pre ~ "scale(%s,%s);".format(scaleWidth, scaleHeight));
		return cast(O) this;
	}
	...
	auto shadowBlur(this O)(uint blur) {
		this.js(pre ~ "shadowBlur=%s;".format(blur));
		return cast(O) this;
	}
...
*/
	...
	auto shadowColor(this O)(string color) {
		this.js(pre ~ "shadowColor=%s;".format(color));
		return cast(O) this;
	}
...
*/
	...
	auto shadowOffsetX(this O)(int value) {
		this.js(pre ~ "shadowOffsetX=%s;".format(value));
		return cast(O) this;
	}
...
*/
	...
	auto shadowOffsetY(this O)(int value) {
		this.js(pre ~ "shadowOffsetY=%s;".format(value));
		return cast(O) this;
	}
...
*/
	...
	auto setTransform(this O)(double a, double b, double c, double d, double e, double f) {
		this.js(pre ~ "setTransform(%s,%s,%s,%s,%s,%s);".format(a, b, c, d, e, f));
		return cast(O) this;
	}
	...
	auto strokeRect(this O)(int x, int y, int width, int height) {
		this.js(pre ~ "strokeRect(%s,%s,%s,%s);".format(x, y, width, height));
		return cast(O) this;
	}
...
*/
	...
	auto strokeText(this O)(string text, double x, double y) {
		this.js(pre ~ "strokeText(%s,%s,%s);".format(text, x, y));
		return cast(O) this;
	}
	...
	auto strokeText(this O)(string text, double x, double y, double maxWidth) {
		this.js(pre ~ "strokeText(%s,%s,%s,%s);".format(text, x, y, maxWidth));
		return cast(O) this;
	}
	...
	auto textAlign(this O)(TextAligns anAlign) {
		this.js(pre ~ "textAlign='%s';".format(anAlign));
		return cast(O) this;
	}
	...
	auto textBaseline(this O)(TextBaselines aBaseline) {
		this.js(pre ~ "textBaseline = '%s';".format(aBaseline));
		return cast(O) this;
	}
	...
	auto translate(this O)(double x, double y) {
		this.js(pre ~ "translate(%s,%s);".format(x, y));
		return cast(O) this;
	}
	...
	auto transform(this O)(double a, double b, double c, double d, double e, double f) {
		this.js(pre ~ "transform(%s,%s,%s,%s,%s,%s);".format(a, b, c, d, e, f));
		return cast(O) this;
	}
	...
	override string toString() {
		if (_id.empty)
			_id = "canvas" ~ to!string(uniform(0, 1_000_000));
