...
private TransportType parseTransportType(string s)
{
    switch (s)
    {
    case "workbench": return TransportType.workbench;
    case "customizing": return TransportType.customizing;
    case "transportOfCopies": return TransportType.transportOfCopies;
    default: return TransportType.workbench;
    }
}
...
private TransportStatus parseTransportStatus(string s)
{
    switch (s)
    {
    case "modifiable": return TransportStatus.modifiable;
    case "released": return TransportStatus.released;
    case "imported": return TransportStatus.imported;
    case "error": return TransportStatus.error;
    default: return TransportStatus.modifiable;
    }
}
