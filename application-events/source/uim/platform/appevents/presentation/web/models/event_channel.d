...
*****************************************************************************************************************/
module uim.platform.appevents.presentation.web.models.event_channel;
...
class WebEventChannelModel {
    ...
    void setItems(EventChannel[] list) { items = list; errorMessage = ""; title = "Event Channels"; }

    void setSelected(EventChannel item, bool found) {
        selected     = item;
        hasSelected  = found;
        title        = found ? "Event Channel: " ~ item.name : "Not Found";
