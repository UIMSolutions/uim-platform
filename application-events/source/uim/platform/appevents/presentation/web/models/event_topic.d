...
*****************************************************************************************************************/
module uim.platform.appevents.presentation.web.models.event_topic;
...
class WebEventTopicModel {
    ...
    void setItems(EventTopic[] list) { items = list; errorMessage = ""; title = "Event Topics"; }

    void setSelected(EventTopic item, bool found) {
        selected     = item;
        hasSelected  = found;
        title        = found ? "Event Topic: " ~ item.name : "Not Found";
