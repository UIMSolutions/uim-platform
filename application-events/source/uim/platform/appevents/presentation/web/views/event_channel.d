...
*****************************************************************************************************************/
module uim.platform.appevents.presentation.web.views.event_channel;
...
class WebEventChannelView {
    Json renderList(WebEventChannelModel model) {
    ...
    Json renderDetail(WebEventChannelModel model) {
