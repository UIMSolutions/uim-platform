...
*****************************************************************************************************************/
module uim.platform.appevents.presentation.gui.models.event_channel;
...
class GuiEventChannelModel {
    protected EventChannel[] _items;
    protected EventChannel   _selected;
    ...
    void setSelected(EventChannel item, bool found) {
        _selected    = item;
        _hasSelected = found;
        _errorMessage = found ? "" : "Event channel not found";
        if (onChanged !is null) onChanged();
    }
