...
class EventSubscriptionController : ManageHttpController {
    ...
    override protected Json getHandler(HTTPServerRequest req) {
        ...
        if (e.isNull)
            return Json.emptyObject.set("error", "Subscription not found").set("statusCode", 404);
    ...
    override protected Json createHandler(HTTPServerRequest req) {
        ...
        return Json.emptyObject.set("id", result.id).set("message", "Subscription created successfully").set("status", "success")
            .set("statusCode", 201);
    }
    ...
    override protected Json updateHandler(HTTPServerRequest req) {
        ...
        if (result.hasError)
            return Json.emptyObject.set("error", result.message).set("statusCode", 400);
        return Json.emptyObject.set("id", result.id).set("message", "Subscription updated successfully").set("status", "success")
            .set("statusCode", 200);
    }
    ...
    override protected Json deleteHandler(HTTPServerRequest req) {
        ...
        return Json.emptyObject.set("id", result.id).set("message", "Subscription deleted successfully").set("status", "success")
            .set("statusCode", 200);
    }
}
