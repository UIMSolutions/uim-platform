...
class EventTopicController : ManageHttpController {
    ...
    override protected Json getHandler(HTTPServerRequest req) {
        ...
        if (e.isNull)
            return Json.emptyObject.set("error", "Topic not found").set("statusCode", 404);
    ...
    override protected Json createHandler(HTTPServerRequest req) {
        ...
        return Json.emptyObject.set("id", result.id).set("message", "Topic created successfully").set("status", "success")
            .set("statusCode", 201);
    }
    ...
    override protected Json updateHandler(HTTPServerRequest req) {
        ...
        return successResponse("Topic updated successfully", "OK", 200, Json.emptyObject.set("id", result.id));
    }
    ...
    override protected Json deleteHandler(HTTPServerRequest req) {
        ...
        return successResponse("Topic deleted successfully", "Deleted", 200, Json.emptyObject.set("id", result.id));
    }
}
