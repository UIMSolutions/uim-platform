...
class DestinationController : HttpController {
    ...
    override protected Json listHandler(HTTPServerRequest req) {
        ...
        auto dests = _usecase.listDestinations(tenantId).map!(e => e.toJson()).array.toJson;
...
override protected Json updateHandler(HTTPServerRequest req) {
    ...
    return successResponse("Destination updated successfully", "Updated", 200, Json.emptyObject.set("id", result
            .id));
}
...
override protected Json deleteHandler(HTTPServerRequest req) {
    ...
    return successResponse("Destination deleted successfully", "Deleted", 200, Json.emptyObject.set("id", result
            .id));
}
}
