...
// Strong-typed IDs
// ---------------------------------------------------------------------------
alias DestinationId    = string; /// RFC Destination name (SM59) — up to 32 chars
alias FunctionModuleId = string; /// Function module name — up to 30 chars
alias RfcCallId        = string; /// UUID of an RFC call record
alias TidValue         = string; /// Transaction ID for tRFC/qRFC/bgRFC (24-char GUID)
alias QueueName        = string; /// Queue name for qRFC/bgRFC — up to 24 chars
alias SystemId         = string; /// SAP System ID (SID) — 3 chars
