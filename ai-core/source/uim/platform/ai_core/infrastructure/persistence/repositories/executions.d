...
*****************************************************************************************************************/
module uim.platform.ai_core.infrastructure.persistence.repositories.executions;
...
@safe:
class ExecutionRepository : TenantRepository!(Execution, ExecutionId), IExecutionRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new ExecutionRepository()));
}
