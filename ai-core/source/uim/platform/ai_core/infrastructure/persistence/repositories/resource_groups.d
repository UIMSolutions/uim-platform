...
*****************************************************************************************************************/
module uim.platform.ai_core.infrastructure.persistence.repositories.resource_groups;
...
@safe:
class ResourceGroupRepository : TenantRepository!(ResourceGroup, ResourceGroupId), IResourceGroupRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new ResourceGroupRepository()));
}
