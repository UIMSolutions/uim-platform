module uim.platform.xyz.application.usecases.track_usage;
...
class TrackUsageUseCase
{
    ...
    UsageEvent[] listByApp(MobileAppId appId) { return eventRepo.findByApp(appId); }
    UsageEvent[] listByUser(MobileAppId appId, string userId) { return eventRepo.findByUser(appId, userId); }
    ...
    ClientLog[] listLogs(MobileAppId appId) { return logRepo.findByApp(appId); }
...
private UsageEventType parseEventType(string s)
{
    switch (s)
    {
    case "appLaunch": return UsageEventType.appLaunch;
    case "screenView": return UsageEventType.screenView;
    case "userAction": return UsageEventType.userAction;
    case "apiCall": return UsageEventType.apiCall;
    case "crash": return UsageEventType.crash;
    case "performanceMetric": return UsageEventType.performanceMetric;
    case "backgroundTask": return UsageEventType.backgroundTask;
    case "pushReceived": return UsageEventType.pushReceived;
    case "syncCompleted": return UsageEventType.syncCompleted;
    default: return UsageEventType.userAction;
    }
}
...
private LogSeverity parseSeverity(string s)
{
    switch (s)
    {
    case "debug_": return LogSeverity.debug_;
