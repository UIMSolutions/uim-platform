...
*****************************************************************************************************************/
module uim.platform.mobile.infrastructure.persistence.repositories.usage_reports;
...
class UsageReportRepository : TenantRepository!(UsageReport, UsageReportId), IUsageReportRepository {
  ...
  UsageReport[] findByDevice(TenantId tenantId, DeviceRegistrationId deviceId) {
    return filterByDevice(findByTenant(tenantId).array, deviceId);
  }
