...
import uim.platform.mobile.application.use_cases.manage_device_registrations;
import uim.platform.mobile.application.use_cases.manage_push_notifications;
import uim.platform.mobile.application.use_cases.manage_push_registrations;
import uim.platform.mobile.application.use_cases.manage_app_configurations;
import uim.platform.mobile.application.use_cases.manage_feature_restrictions;
import uim.platform.mobile.application.use_cases.manage_client_resources;
import uim.platform.mobile.application.use_cases.manage_app_versions;
import uim.platform.mobile.application.use_cases.manage_usage_reports;
import uim.platform.mobile.application.use_cases.manage_offline_stores;
import uim.platform.mobile.application.use_cases.manage_user_sessions;
