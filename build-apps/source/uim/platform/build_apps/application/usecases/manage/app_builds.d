...
class ManageAppBuildsUseCase {
    private IAppBuildRepository repo;

    this(IAppBuildRepository repo) {
        this.repo = repo;
    }
...
///
unittest {
    auto repo = new AppBuildRepository();
    auto usecase = new ManageAppBuildsUseCase(repo);
