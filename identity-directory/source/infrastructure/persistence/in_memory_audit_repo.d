module infrastructure.persistence.in_memory_audit_repo;
...
class InMemoryAuditRepository : AuditRepository
{
    ...
    {
        return filterPaged(
            (AuditEvent e) => e.tenantId == tenantId,
            offset, limit
        );
    }
    ...
    {
        return filterPaged(
            (AuditEvent e) => e.actorId == actorId,
            offset, limit
        );
    }
    ...
    {
        return filterPaged(
            (AuditEvent e) => e.targetId == targetId,
            offset, limit
        );
    }
    ...
    {
        return filterPaged(
            (AuditEvent e) => e.tenantId == tenantId && e.eventType == eventType,
            offset, limit
        );
    }
    ...
    {
        return filterPaged(
            (AuditEvent e) => e.tenantId == tenantId && e.timestamp >= from && e.timestamp <= to,
            offset, limit
        );
    }
