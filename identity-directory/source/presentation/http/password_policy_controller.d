module uim.platform.identity_authentication.presentation.http.password_policy_controller;
    ...
    private void handleCreate(scope HTTPServerRequest req, scope HTTPServerResponse res)
    {
        try
        {
            ...
            auto createReq = CreatePasswordPolicyRequest(
                ...
                jsonBool(j, "requireLowercase", true),
                jsonBool(j, "requireDigit", true),
                jsonBool(j, "requireSpecialChar"),
