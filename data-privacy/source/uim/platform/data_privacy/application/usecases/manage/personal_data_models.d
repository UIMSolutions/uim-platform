...
*****************************************************************************************************************/
module uim.platform.data_privacy.application.usecases.manage.personal_data_models;
...
class ManagePersonalDataModelsUseCase {
  protected IPersonalDataModelRepository repo;

  this(IPersonalDataModelRepository repo) {
    this.repo = repo;
  }
