...
*****************************************************************************************************************/
module uim.platform.data_privacy.infrastructure.persistence.repositories.data_controllers;

// import uim.platform.data_privacy.domain.entities.data_controller;
// import uim.platform.data_privacy.domain.ports.data_controller_repository;
import uim.platform.data_privacy;

mixin(ShowModule!());

@safe:
class DataControllerRepository : TenantRepository!(DataController, DataControllerId), IDataControllerRepository {
