...
*****************************************************************************************************************/
module uim.platform.data_privacy.infrastructure.persistence.repositories.consent_purposes;

// import uim.platform.data_privacy.domain.entities.consent_purpose;
// import uim.platform.data_privacy.domain.ports.consent_purpose_repository;
import uim.platform.data_privacy;

mixin(ShowModule!());

@safe:
class ConsentPurposeRepository : TenantRepository!(ConsentPurpose, ConsentPurposeId), IConsentPurposeRepository {
