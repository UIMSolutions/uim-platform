...
*****************************************************************************************************************/
module uim.platform.data_privacy.infrastructure.persistence.repositories.correction_requests;

// import uim.platform.data_privacy.domain.entities.correction_request;
// import uim.platform.data_privacy.domain.ports.correction_request_repository;
import uim.platform.data_privacy;

mixin(ShowModule!());

@safe:
class CorrectionRequestRepository : TenantRepository!(CorrectionRequest, CorrectionRequestId), ICorrectionRequestRepository {
