module application.use_cases.manage_data_subjects;
...
class ManageDataSubjectsUseCase
{
    ...
    CommandResult updateSubject(UpdateDataSubjectRequest req)
    {
        ...
        if (req.displayName.length > 0) subject.displayName = req.displayName;
        if (req.email.length > 0) subject.email = req.email;
        if (req.sourceSystem.length > 0) subject.sourceSystem = req.sourceSystem;
        if (req.country.length > 0) subject.country = req.country;
        subject.subjectType = req.subjectType;
