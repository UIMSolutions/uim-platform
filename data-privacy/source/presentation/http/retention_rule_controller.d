module presentation.http.retention_rule_controller;
...
class RetentionRuleController
{
    ...
    private static RetentionRuleStatus parseRuleStatus(string s)
    {
        switch (s)
        {
            case "inactive": return RetentionRuleStatus.inactive;
            case "expired": return RetentionRuleStatus.expired;
            default: return RetentionRuleStatus.active;
        }
    }
}
