...
*****************************************************************************************************************/
module uim.platform.analytics.infrastructure.persistence.memory.repositories.plannings;
...
// mixin(ShowModule!());
@safe:
class MemoryPlanningRepository : TentRepository!(PlanningModel, PlanningModelId), PlanningRepository {
