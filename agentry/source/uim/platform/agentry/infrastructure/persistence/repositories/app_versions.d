...
*****************************************************************************************************************/
module uim.platform.agentry.infrastructure.persistence.repositories.app_versions;
...
class AppVersionRepository : TenantRepository!(AppVersion, AppVersionId), IAppVersionRepository {
    mixin TenantRepositoryTemplate!(AppVersionRepository, AppVersion, AppVersionId);
...
///
unittest {
    assert(tenantRepositoryTest(new AppVersionRepository));
}