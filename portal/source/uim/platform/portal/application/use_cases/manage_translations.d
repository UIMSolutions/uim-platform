module uim.platform.portal.application.usecases.manage_translations;
...
class ManageTranslationsUseCase
{
    ...
    Translation[] getTranslationsForResource(string resourceType, string resourceId, string language = "")
    {
        return translationRepo.findByResource(resourceType, resourceId, language);
    }

    Translation[] listTranslations(TenantId tenantId, string language, uint offset = 0, uint limit = 100)
    {
