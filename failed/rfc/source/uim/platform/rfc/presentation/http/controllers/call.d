...
class CallController : HttpController {
    ...
    override protected Json listHandler(HTTPServerRequest req) {
        ...
        if (!hasStatus)
            calls = _manageUC.listCalls(tenantId);
    ...
    override protected Json getHandler(HTTPServerRequest req) {
        ...
        if (call.isNull()) {
            return errorResponse("RFC call not found", 404);
        }
        return successResponse("RFC call retrieved successfully", "Retrieved", 200, call.toJson());
    }
...
override protected Json deleteHandler(HTTPServerRequest req) {
    ...
    return successResponse("RFC call deleted successfully", "Deleted", 200, Json.emptyObject.set("id", result.id));
}
...
static RfcStatus _parseStatus(string s) {
    ...
    switch (s.toLower()) {
    case "pending":
        return RfcStatus.pending;
    case "executing":
        return RfcStatus.executing;
    case "queued":
        return RfcStatus.queued;
    case "committed":
        return RfcStatus.committed;
    case "rolledback":
        return RfcStatus.rolledBack;
    case "succeeded":
        return RfcStatus.succeeded;
    case "failed":
        return RfcStatus.failed;
    case "timedout":
        return RfcStatus.timedOut;
    default:
        return RfcStatus.pending;
    }
}
