...
*****************************************************************************************************************/
module uim.platform.responsibility.presentation.http.controllers.responsibility_definition;
...
class ResponsibilityDefinitionController : ManageHttpController {
    private ManageResponsibilityDefinitionsUseCase _uc;

    this(ManageResponsibilityDefinitionsUseCase uc) { _uc = uc; }
    ...
    override void registerRoutes(URLRouter router) {
        ...
        router.put   ("/api/v1/responsibility/definitions/*",  &handleUpdate);
        router.delete_("/api/v1/responsibility/definitions/*", &handleDelete);
    }
    ...
    override protected Json createHandler(HTTPServerRequest req) {
        ...
        dto.ruleId       = data.getString("ruleId", "");
