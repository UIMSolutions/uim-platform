...
*****************************************************************************************************************/
module uim.platform.dms.application.infrastructure.persistence.repositories.document_versions;
...
///
unittest {
    assert(tenantRepositoryTest(new DocumentVersionRepository()));
}
