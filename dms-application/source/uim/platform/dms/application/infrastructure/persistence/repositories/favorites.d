...
*****************************************************************************************************************/
module uim.platform.dms.application.infrastructure.persistence.repositories.favorites;
...
class FavoriteRepository : TenantRepository!(Favorite, FavoriteId), IFavoriteRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new FavoriteRepository()));
}
