...
*****************************************************************************************************************/
module uim.platform.dms.application.infrastructure.persistence.repositories.shares;
...
@safe:
class ShareRepository : TenantRepository!(Share, ShareId), IShareRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new ShareRepository()));
}
