...
class SnowflakeWarehouseController : ManageHttpController {
  protected ManageSnowflakeWarehousesUseCase usecase;
  this(ManageSnowflakeWarehousesUseCase usecase) {
  ...
  void handleCreate(HTTPServerRequest req, HTTPServerResponse res) {
    ...
    if (j["autoSuspend"].isInteger)
      r.autoSuspend = cast(int)j["autoSuspend"].get!long;
  ...
  void handleUpdate(HTTPServerRequest req, HTTPServerResponse res) {
    ...
    return successResponse("Warehouse updated successfully", "Updated", 200, responseData);
  }
