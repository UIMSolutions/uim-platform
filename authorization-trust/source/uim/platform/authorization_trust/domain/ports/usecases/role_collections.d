...
*****************************************************************************************************************/
module uim.platform.authorization_trust.domain.ports.usecases.role_collections;
...
class ManageRoleCollectionsUseCase {
  protected IRoleCollectionRepository repo;

  this(IRoleCollectionRepository repo) {
    this.repo = repo;
  }
