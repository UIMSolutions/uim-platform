...
class WebBackupPolicyModel {
    ...
    void setPolicies(BackupPolicy[] list) { policies = list; pageTitle = "Backup Policies (" ~ list.length.to!string ~ ")"; errorMessage = ""; }
    void setSelected(BackupPolicy p, bool found) {
        selected = p; hasSelected = found;
        pageTitle = found ? "Policy: " ~ p.id.value : "Policy Not Found";
