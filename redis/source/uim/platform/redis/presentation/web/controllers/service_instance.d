...
*****************************************************************************************************************/
module uim.platform.redis.presentation.web.controllers.service_instance;
...
/// Web MVC Controller for ServiceInstance — registers HTML web routes and wires model + view.
class WebServiceInstanceController {
    ...
    void registerRoutes(URLRouter router) {
        router.get("/web/redis/instances",     &handleList);
        router.get("/web/redis/instances/*",   &handleDetail);
        router.post("/web/redis/instances",    &handleCreate);
        router.post("/web/redis/instances/*",  &handleDelete);
    }
