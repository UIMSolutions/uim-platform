...
class BackupController : ManageHttpController {
  ...
  override protected Json listHandler(HTTPServerRequest req) {
    ...
    return successResponse("Backups retrieved successfully", 200, response);
  }
  ...
  override protected Json getHandler(HTTPServerRequest req) {
    ...
    return successResponse("Backup retrieved successfully", 200, resp);
  }
  ...
  override protected Json updateHandler(HTTPServerRequest req) {
    ...
    return successResponse("Backup updated successfully", "Updated", 200, responseData);
  }
  ...
  override protected Json deleteHandler(HTTPServerRequest req) {
    ...
    auto responseData = Json.emptyObject.set("id", result.id);
    return successResponse("Backup deleted successfully", "Deleted", 200, responseData);
  }
}
