...
*****************************************************************************************************************/
module uim.platform.abap_environment.presentation.gui.views.business_role;
...
class BusinessRoleWindow : ApplicationWindow {
  ...
  private TreeView buildTreeView() {
    ...
    tv.appendColumn(new TreeViewColumn("Role Type",   new CellRendererText(), "text", 2));
