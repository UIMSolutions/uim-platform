...
*****************************************************************************************************************/
module uim.platform.abap_environment.presentation.gui.views.communication_arrangement;
...
class CommunicationArrangementWindow : ApplicationWindow {
  ...
  this(Application app, ManageCommunicationArrangementsUseCase usecase) {
    ...
    setTitle("Communication Arrangements");
  ...
  private TreeView buildTreeView() {
    ...
    tv.appendColumn(new TreeViewColumn("Comm. System", new CellRendererText(), "text", 2));
