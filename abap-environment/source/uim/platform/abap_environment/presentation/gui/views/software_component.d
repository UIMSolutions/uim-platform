...
*****************************************************************************************************************/
module uim.platform.abap_environment.presentation.gui.views.software_component;
...
class SoftwareComponentWindow : ApplicationWindow {
  private ManageSoftwareComponentsUseCase usecase;
  private TreeView treeView;

  this(Application app, ManageSoftwareComponentsUseCase usecase) {
    super(app);
    this.usecase = usecase;
    setTitle("Software Components");
  ...
  private TreeView buildTreeView() {
    ...
    tv.appendColumn(new TreeViewColumn("Version", new CellRendererText(), "text", 2));
