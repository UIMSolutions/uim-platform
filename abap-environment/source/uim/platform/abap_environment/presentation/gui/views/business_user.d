...
*****************************************************************************************************************/
module uim.platform.abap_environment.presentation.gui.views.business_user;
...
class BusinessUserWindow : ApplicationWindow {
  ...
  private TreeView buildTreeView() {
    ...
    tv.appendColumn(new TreeViewColumn("User Name",  new CellRendererText(), "text", 1));
    tv.appendColumn(new TreeViewColumn("First Name", new CellRendererText(), "text", 2));
    tv.appendColumn(new TreeViewColumn("Last Name",  new CellRendererText(), "text", 3));
    return tv;
  }
