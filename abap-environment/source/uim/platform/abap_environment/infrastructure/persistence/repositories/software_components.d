...
// mixin(ShowModule!());
@safe:
class SoftwareComponentRepository : TenantRepository!(SoftwareComponent, SoftwareComponentId), ISoftwareComponentRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new SoftwareComponentRepository()));
}
