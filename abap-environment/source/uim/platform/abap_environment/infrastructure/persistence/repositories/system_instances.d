...
*****************************************************************************************************************/
module uim.platform.abap_environment.infrastructure.persistence.repositories.system_instances;
...
// mixin(ShowModule!());
@safe:
class SystemInstanceRepository : TenantRepository!(SystemInstance, SystemInstanceId), ISystemInstanceRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new SystemInstanceRepository()));
}
