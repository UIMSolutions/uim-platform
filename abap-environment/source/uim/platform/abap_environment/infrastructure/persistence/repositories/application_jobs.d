...
*****************************************************************************************************************/
module uim.platform.abap_environment.infrastructure.persistence.repositories.application_jobs;
...
class ApplicationJobRepository : TenantRepository!(ApplicationJob, ApplicationJobId), IApplicationJobRepository {
...
///
unittest {
    assert(tenantRepositoryTest(new ApplicationJobRepository()));
}
