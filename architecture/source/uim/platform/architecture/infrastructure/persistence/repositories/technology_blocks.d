...
class TechnologyBlockRepository : TenantRepository!(TechnologyBlock, TechnologyBlockId), ITechnologyBlockRepository {
    ...
    TechnologyBlock[] filterByDomain(TechnologyBlock[] blocks, ArchiMateDomain domain) {
    ...
    TechnologyBlock[] filterByAspect(TechnologyBlock[] blocks, ArchiMateAspect aspect) {
...
unittest {
    ...
    void testTechnologyBlockRepository() {
        auto repo = new TechnologyBlockRepository();
        auto tenantId = TenantId("tenant1");
        auto block1 = TechnologyBlock(tenantId, TechnologyBlockId("block1"));
        block1.title = "Block 1";
        block1.description = "Description 1";
        block1.status = LifecycleStatus.active;
        block1.archimateDomain = ArchiMateDomain.technology;
        block1.archimateAspect = ArchiMateAspect.activeStructure;
        repo.save(block1);

        auto block2 = TechnologyBlock(tenantId, TechnologyBlockId("block2"));
        ...
        auto block3 = TechnologyBlock(tenantId, TechnologyBlockId("block3"));
        block3.title = "Block 3";
        block3.description = "Description 3";
        block3.status = LifecycleStatus.active;
        block3.archimateDomain = ArchiMateDomain.technology;
        ...
        assert(repo.countByDomain(tenantId, ArchiMateDomain.technology) == 2);
